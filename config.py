...
data_arg.add_argument('--valid_num', type=int, default=1024)
data_arg.add_argument('--test_num', type=int, default=1024)
data_arg.add_argument('--train_set', type=str, default="")
data_arg.add_argument('--valid_set', type=str, default="")
data_arg.add_argument('--test_set', type=str, default="")
data_arg.add_argument('--train_npz', type=str, default="")
data_arg.add_argument('--valid_npz', type=str, default="")
data_arg.add_argument('--test_npz', type=str, default="")
...
train_arg.add_argument('--max_step', type=int, default=500000, help='')
train_arg.add_argument('--lr_start', type=float, default=0.0005, help='')
...
train_arg.add_argument('--checkpoint_secs', type=int, default=2000, help='')

# Misc
misc_arg = add_argument_group('Misc')
misc_arg.add_argument('--log_step', type=int, default=1000, help='')
misc_arg.add_argument('--num_log_samples', type=int, default=10, help='')
...
misc_arg.add_argument('--load_model', type=str, default='')
misc_arg.add_argument('--debug', type=str2bool, default=False)
misc_arg.add_argument('--gpu_memory_fraction', type=float, default=0.2)
